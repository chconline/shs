					...
					<div class="triple-box-container">
						<div class="triple-box">
							...
							<div class="triple-box-text-container">
								<h5 class="triple-box-heading"><?php the_sub_field( 'heading' ); ?></h5>
								<div class="triple-box-sub-heading"><?php the_sub_field( 'sub-heading' ); ?></div>
								<?php $button = get_sub_field( 'button' ); ?>
								<?php if ( $button ) { ?>
									<a class="btn <?php the_sub_field( 'btn_style' ); ?>" href="<?php echo $button['url']; ?>" target="<?php echo $button['target']; ?>"><?php echo $button['title']; ?></a>
								<?php } ?>
							</div>
						</div>
					</div>
